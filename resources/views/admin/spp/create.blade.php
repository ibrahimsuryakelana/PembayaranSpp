...
<body>
    <h3>Input Spp</h3>
    <form action="/admin/spp/store" method="post">
        @csrf
        <div class="form-group">
            <label for="">Tahun Ajaran</label>
            <input class="form-control" required type="number" name="tahun" id="" >
        </div>

        <div class="form-group">
            <label for="">Nominal</label>
            <input class="form-control" required type="number" name="nominal" id="" >
        </div>
